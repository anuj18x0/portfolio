...
const AvatarDemoVideo = () => {
  ...
  return (
    <div style={containerStyle} className="video-container video-fullscreen">
      ...
      <iframe
        src="https://drive.google.com/file/d/1xMzJf8mV21vLrYekmYr8OfC__UHiXlV_/preview"
        allow="autoplay; fullscreen"
        allowFullScreen
        style={iframeStyle}
        className="video-iframe"
        title="3D Avatar Demo Video"
      />
    </div>
  );
};

export default AvatarDemoVideo;
